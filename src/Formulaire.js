  ...
  return (
    <>
      {text ? (
        <div>
          <h1>
            Je suis {idenfiant} né le {date_n} à {ville} et mes loisirs sont:{" "}
            {loisir}
            <hr />
            {filebase64 && (
              <>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div id="L">
              ...
              <input
                type="text"
                required
                onChange={(event) => setIdenfiant(event.target.value)}
              />
            </div>
            <div id="mdp">
            ...
            <div id="dtn">
              ...
              <input
                type="date"
                required
                onChange={(event) => setDate_n(event.target.value)}
              />
            </div>
            <div id="ville">
